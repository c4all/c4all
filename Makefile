...
less:
	$(LESS) c4all/staticfiles/admin_ui/less/style.less \
		> c4all/staticfiles/admin_ui/css/style.css

	$(LESS) c4all/staticfiles/less/style.less \
                > c4all/staticfiles/css/style.css


deploy:
	git pull
	$(MAKE) prod-update
	sudo restart c4all-web
