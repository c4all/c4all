...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomUser.hidden'
        db.delete_column(u'comments_customuser', 'hidden')

        # Adding M2M table for field hidden on 'CustomUser'
        db.create_table(u'comments_customuser_hidden', (
        ...
        db.create_unique(u'comments_customuser_hidden', ['customuser_id', 'site_id'])


    def backwards(self, orm):
        # Adding field 'CustomUser.hidden'
        db.add_column(u'comments_customuser', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing M2M table for field hidden on 'CustomUser'
        db.delete_table('comments_customuser_hidden')
    ...
    models = {
        ...
        u'comments.customuser': {
            ...
            'hidden': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['comments.Site']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
